...
Copy from https://github.com/tensorflow/nmt/blob/master/nmt/scripts/rouge.py
...
def rouge_n(evaluated_sentences, reference_sentences, n=4):
    """
...
def compute_rouge(hypotheses, references):
    ...
    Args:
        hypotheses: list of predictions to score. Each predictions
    ...
    rouge_3 = [
        rouge_n([hyp], [ref], 3) for hyp, ref in zip(hypotheses, references)
    ]
