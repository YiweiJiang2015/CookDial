"""
Assorted utilities for working with neural networks in AllenNLP 2.4.0.
"""
...
from typing import Any, Dict, List, Optional, Sequence, Tuple, TypeVar, Union, Set
...
# funcs below are copied from allennlp/training/util 2.4.0
